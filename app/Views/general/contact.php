...
<?php $this->start('main_content') ?>
    ...
    <section class="container contact-form">
            ...
            <form action="<?= $this->url('login') ?>" method="post" class="form" id="contact-form">
                ...
                <div class="form-group <?php if (isset($error['contact_objet'])) { echo 'has-error'; } ?>">
                    ...
                    <select name="contact_objet" id="">
                        ...
                        <option value="">Devenir Producteur</option>
                        <option value="">Proposition</option>
                        <option value="">Dire Bonjour</option>
                    </select>
                ...
                <div class="form-group <?php if (isset($error['contact_msg'])) { echo 'has-error'; } ?>">
                    ...
                    <textarea name="contact_msg" class="form-control" required="required" data-min="10" data-max="1500" autocomplete="off" />value="<?= htmlentities($msg); ?></textarea>
