...
$w_config = [
	...
	'db_host' => 'mysql-winenot.alwaysdata.net',    //hôte (ip, domaine) de la bdd
	'db_user' => 'winenot',							//nom d'utilisateur pour la bdd
	'db_pass' => '^w1n0te',								//mot de passe de la bdd
	'db_name' => 'winenot_project',								//nom de la bdd
	...
	'security_login_route_name' => 'account',			//nom de la route affichant le formulaire de connexion

	// configuration globale
	'site_name'	=> 'WineNot', 								// contiendra le nom du site
];
